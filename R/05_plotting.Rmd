...
`ggplot1` was released in **2005** until **2008** by [Hadley Wickham](https://github.com/hadley/ggplot1).

> If the pipe ( %>% in 2014) had been invented before, `ggplot2` would have never existed | Hadley Wickham

### {.box-6 .bg-bluew}

```{r, eval = FALSE, title = "`ggplot1`: original syntax"}
...
```{r, eval = FALSE, title = "`ggplot1` with the pipe"}
library(ggplot1)
mtcars %>% 
