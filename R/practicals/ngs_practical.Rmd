...
Load the file `corpasome.trio.chr22.snps.filtered.annovar.tsv` into R.
 1. *why* Filter the columns `corpasome_dad`, `corpasome_mom`, `corpasome_daughter` with patterns “01,01,11” respectively  and save the new file as `corpasome.trio.chr22.snps.filtered.annovar.recessive`.
