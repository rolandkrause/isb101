...
## Aims
You will receive a set of exome data for a family trio to identify a disease-causing variant using the tools presented in the course. 
Your task for this case report is to summarize the steps leading to the variant and to reflect on how you get there. 
Your report should be reproducible using RMarkdown and code where possible. 

Minimally include two graphs and two computed tables in the Results sections that are purely produced from code. 
Use computed results in the text at least twice. 
There are many possibilities in this report.
...
What variant and gene been found? 
