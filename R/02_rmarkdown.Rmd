...
output:
  iosp::ioslides_plus:
    footer: "Best practices in Research Data Management"
---
...
### **Lightweight** markup language{.box-6 .bg-blue .outline}
 ...
 * [RStudio Cloud](https://rstudio.cloud/) is a free R session in the browser.
* Register for free.
* Create a new project.
* Create a new RMarkdown document from the Menu.
* Upload the peak lists as created 
