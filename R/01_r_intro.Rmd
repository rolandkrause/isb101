...
### Original creators {.bg-blue .offset1-1 .box-10}
...
- R1 Intro (this morning)
- R2 Tidy data (Mon afternoon)
- R3 Getting data into R (Tuesday morning)
- R4 Data manipulation (Tue afternoon)
