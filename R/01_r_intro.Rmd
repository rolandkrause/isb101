...
## Practice time! | Getting started {.bg-green}
...
- In the end of the lesson send the email to `r swirl_mailto`\
  The email subject should be generated automatically by swirl, in the email body place your last command used in the lesson.
...
### Vector recyling {.box-8 .offset-2 .bg-red .icon-small}
...
### Main functions{.box-8 .offset-2 .bg-yellow}
...
## Practice time! | Vectors and logical {.bg-green}

### {.box-10 .offset-1 .bg-white}
...
## Practice time! | More on vectors {.bg-green}
...
## Structures for categorical data | Factors
...
## Structures for arbitrary elements | Lists
...
## Structures for tabular data {.build}

### Matrix and Arrays {.box-8 .offset-2 .bg-blue .show .stretch}
...
### Data frames {.box-8 .offset-2 .bg-bluew .show .stretch}
...
## Practice time! | Matrix and data frame {.bg-green}
...
## Practice time! | Functions {.bg-green}
...
## Vectorisation | Advice

### Beginner's mistakes {.box-6 .offset-3 .bg-yellow .icon-small}
 * Not using vectorisation because for loops are thought to be *easier*.
 * Writing too much intermediate code when looping over data structures.
 * Modifying a vector in a for loop (super slow)
 * In the end, purrr::map() and apply() **are** for loops that are more efficient.  
 * When you don't know anymore, write a for loop anyway (e.g. when moving around in columns and rows in a matrix)
...
## Conclusions {.bg-assign}

### Review {.bg-blue .box-8 .offset-2 .icon}
 * Vectors are at the core and vectorisations makes things fast 
...
### Thank you for your attention! {.bg-yellow .box-8 .offset-2}
Enjoy R wherever you encounter it!
